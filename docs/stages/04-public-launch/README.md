...
| L18 | P1 | Производительность прогона: отставание от Playwright-участников на свежем процессе | L12 | 4 | a3 | M |
...
Фаза 4  L18 → L12 → L11 раннер                          ← сначала производительность
...
| L06 | реализовано, ждёт PR | — | `tests/test_native.py` | — |
| L14 | реализовано, ждёт PR | — | — | — |
| L17 | реализовано, ждёт PR | — | — | — |
...
| L13 | не начато | — | — | — |
| L05 | мини-часть выполнена | — | 30 раундов, пять участников, `26ce56e` | README-блок по решению владельца; корректность и авторинг — фаза 6 |
| L15 | не начато | — | — | — |
| L18 | не начато | — | — | профилирование |
