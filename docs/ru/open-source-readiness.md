...
Репозиторий стал публичным, а GitHub private vulnerability reporting включён и проверен
через API 21 сентября 2026 года. Публикация заблокирована до повторного сканирования
чистого финального RC commit и review всех предназначенных для публикации материалов.
См. [support policy](../../SUPPORT.md),
